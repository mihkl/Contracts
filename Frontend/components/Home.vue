<template>
  <div v-if="auth.isAuthenticated.value" class="mt-10 px-4">
    ...
    <form class="space-y-6">
      ...
      <button type="button" @click="submitFile"
  ...
  <div v-else class="mt-10 px-4">
    <a href="/login" class="text-3xl font-semibold mb-6">Please log in to upload a template</a>
  </div>
</template>
