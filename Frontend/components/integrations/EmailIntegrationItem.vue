<template>
  ...
  >
    ...
    <div class="flex flex-row gap-4 items-center mb-4">
      <UToggle
        v-model="notifyOnContractUploadSelected"
        @change="handleContractUploadToggle"
      />
    ...
    <div class="flex flex-row gap-4 items-center mb-4">
      <UToggle
        v-model="sendFinalContractSelected"
    ...
    <div v-if="sendFinalContractSelected" class="mb-4">
      <UFormGroup
        ...
        name="signatureNotificationEmail"
        class="mb-4"
        :required="true"
      >
        <UInput
  ...
  >
    ...
    <UFormGroup label="From email" name="email" class="mb-4" :required="true">
      ...
      />
      <p v-if="errors.fromEmail" class="text-red-500 text-sm">
        {{ errors.fromEmail }}
      </p>
    </UFormGroup>
  </div>
...
const submit = async () => {
  ...
  const payload = {
    ...state,
    notifyOnUploadContent: notifyOnContractUploadSelected.value
      ? state.notifyOnUploadContent
      : "",
    notifyOnUploadSubject: notifyOnContractUploadSelected.value
      ? state.notifyOnUploadSubject
      : "",
    signatureNotificationEmail: sendFinalContractSelected.value
      ? state.signatureNotificationEmail
      : "",
    notifyOnSignatureContent: sendFinalContractSelected.value
      ? state.notifyOnSignatureContent
      : "",
    notifyOnSignatureSubject: sendFinalContractSelected.value
      ? state.notifyOnSignatureSubject
      : "",
    documentIsAttached: notifyOnContractUploadSelected.value
      ? state.documentIsAttached
      : false,
    notificationDocumentIsAttached: sendFinalContractSelected.value
      ? state.notificationDocumentIsAttached
      : false,
  };
