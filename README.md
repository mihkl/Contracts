...
5. If the image has been successfully created, run `docker run -p 5143:80 -e HMACSecretKey=123456 -e ASPNETCORE_ENVIRONMENT=Development isa3`, where isa3 is the name of the image selected in step 3 and HMACSecretKey is equal to secret key used when generating HMAC signatures (in the example above, the secret key is going to have a value of 123456).
...
```
cd existing_repo
git remote add origin https://gitlab.cs.taltech.ee/kekoos/itb2203_2024_lepingud.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.taltech.ee/kekoos/itb2203_2024_lepingud/-/settings/integrations)
