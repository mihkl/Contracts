...
5. If the image has been successfully created, run `docker run -p 8080:8080 -e HMACSecretKey=123456 isa3`, where isa3 is the name of the image selected in step 3 and HMACSecretKey is equal to secret key used when generating HMAC signatures (in the example above, the secret key is going to have a value of 123456).
